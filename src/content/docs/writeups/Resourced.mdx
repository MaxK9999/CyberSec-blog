...
>[!note]
>Ah yes, yet again a **Resource-Based Constrained Delegation** attack, just like in [[Laser#Resource Based Constrained Delegation (RBCD)]] 
...
#RBCD #pass-the-hash #pass-the-ticket #impacket #secretsdump #BloodHound 